...
//           "https://api-emsdev-be-epb9fbg0e7ewese6.southindia-01.azurewebsites.net/task/getall",
//           { headers: { Authorization: `Bearer ${token}` } }
//         );
...
//           `https://api-emsdev-be-epb9fbg0e7ewese6.southindia-01.azurewebsites.net/managers/${id}/assigned-employees`
//         );
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        /* TASKS */
        const taskRes = await axios.get(
          `https://api-emsdev-be-epb9fbg0e7ewese6.southindia-01.azurewebsites.net/tasks/${user._id}`,
          {
            headers: { Authorization: `Bearer ${token}` },
          },
        );
  ...
  useEffect(() => {
    const fetchAvailableEmployees = async () => {
      try {
        ...
        const res = await axios.get(`https://api-emsdev-be-epb9fbg0e7ewese6.southindia-01.azurewebsites.net/bench-employees`, {
          headers: {
