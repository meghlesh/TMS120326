...
const MangerTaskTMS = ({ role }) => {
    ...
    const fetchAddTaskRequiredDetails = async () => {
      try {
        ...
        const projectRes = await axios.get(
          `https://api-emsdev-be-epb9fbg0e7ewese6.southindia-01.azurewebsites.net/api/projects/unique-names/${user._id}`,
        );
        const teamsRes = await axios.get("https://api-emsdev-be-epb9fbg0e7ewese6.southindia-01.azurewebsites.net/api/teams");
  ...
  async function handleAddTask(e) {
    ...
    try {
      ...
      // if (editTaskId) {
      //   await axios.put(`https://api-emsdev-be-epb9fbg0e7ewese6.southindia-01.azurewebsites.net/task/${editTaskId}`, formData, {
      //     headers: { "Content-Type": "multipart/form-data" },
      //   });
      // } else {
      //   await axios.post("https://api-emsdev-be-epb9fbg0e7ewese6.southindia-01.azurewebsites.net/task/create", formData, {
      //     headers: {
      //       "Content-Type": "multipart/form-data",
      //       Authorization: `Bearer ${token}`,
      //     },
  ...
  //       );
  //     } else {
  //       res = await axios.post("https://api-emsdev-be-epb9fbg0e7ewese6.southindia-01.azurewebsites.net/task/create", formData, {
  //         headers: {
  //           "Content-Type": "multipart/form-data",
  //           Authorization: `Bearer ${token}`,
  //         },
